  ...
  try {
    ...
    db.prepare(`
      UPDATE projects SET
        ...
        db_table_name = ?,
        article_folder_id = ?, factcheck_folder_id = ?, review_folder_id = ?, credentials_path = ?,
    ...
    `).run(
      ...
      // factcheck_folder_id: legacy column, mirror review_folder_id for backward compat
      body.review_folder_id || body.factcheck_folder_id || '',
      body.review_folder_id || body.factcheck_folder_id || '',
